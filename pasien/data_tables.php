...
<div class="content" style="width:max-content;">
    ...
    <div class="item">
        ...
        <h4>
            ...
            <a href="add_data.php?id=<?=$id?>" class="add"><i class="fa-solid fa-file-circle-plus"></i>Tambah data</a>
            ...
            if ($_SERVER['REQUEST_METHOD'] == "POST" || $_SERVER['REQUEST_METHOD'] == "GET") {
                ...
                if ($pencarian != '') {
                    $sql = "SELECT * FROM tb_rm INNER JOIN tb_pasien ON tb_rm.id_pasien = tb_pasien.id_pasien
                            ...
                            WHERE no_rm LIKE '%$pencarian%' AND tb_pasien.id_pasien = '$id'";
                    $query = $sql;
                    $queryjml = $sql;
                } else {
                    $query = "SELECT * FROM tb_rm 
                            ...
                            INNER JOIN tb_user ON tb_rm.id_dokter = tb_user.id_user
                            WHERE tb_pasien.id_pasien = '$id'
                            ORDER BY no_rm ASC LIMIT $posisi, $batas";
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            $sql_obat = mysqli_query($con, "SELECT * FROM tb_rm_obat 
                                                            INNER JOIN tb_obat ON tb_rm_obat.id_obat = tb_obat.id_obat 
                        ...
                        <td class="edit">
                            <a href="../rm/del.php?id=<?= $data['id_rm'] ?>" onclick="return confirm('Yakin hapus data?')">
                                <i class="fa-solid fa-trash delete"></i>
                            </a>
                            <a href="../rm/details_data.php?id=<?= $data['id_rm'] ?>" class="link-search-btn">
...
<?php
    ...
    echo "<h1>Tidak ada Data Rekam Medis</h1>";
}
?>
</div>
